...
adb shell mv -f -i /data/data/com.pubg.imobile/lib /data/data/com.pubg.imobilelib > nul 2>&1
adb shell rm -rf /data/data/com.pubg.imobile > nul 2>&1 
adb shell mkdir /data/data/com.pubg.imobile > nul 2>&1
adb shell mkdir /data/data/com.pubg.imobile/shared_prefs > nul 2>&1
adb shell mv -f -i /data/data/com.pubg.imobilelib /data/data/com.pubg.imobile/lib > nul 2>&1
adb shell chmod -R 777 /data/data/com.pubg.imobile/shared_prefs > nul 2>&1 
adb push %TEMP%\device_id.xml /data/data/com.pubg.imobile/shared_prefs > nul 2>&1
...
adb shell rm -rf /data/media/0/Android/data/com.tencent.ams > nul 2>&1 
...
adb shell rm -rf /data/media/0/centauri > nul 2>&1
adb shell rm -rf /data/media/0/CentauriOversea > nul 2>&1
adb shell rm -rf /data/media/0/SysQS > nul 2>&1
...
adb shell touch /data/media/0/Android/data/com.tencent.ams > nul 2>&1 
adb shell touch /data/media/0/centauri > nul 2>&1
adb shell touch /data/media/0/CentauriOversea > nul 2>&1
adb shell touch /data/media/0/SysQS > nul 2>&1
...
adb shell mv -f -i /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/paks /data/media/0/paks > nul 2>&1
adb shell mv -f -i /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/lightdata /data/media/0/lightdata > nul 2>&1
adb shell mv -f -i /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SrcVersion.ini /data/media/0/SrcVersion.ini > nul 2>&1
adb shell mv -f -i /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/savegames/active.sav /data/media/0/active.sav > nul 2>&1
adb shell rm -rf /data/media/0/Android/data/com.pubg.imobile > nul 2>&1 
adb shell mkdir /data/media/0/Android/data/com.pubg.imobile > nul 2>&1 
adb shell mkdir /data/media/0/Android/data/com.pubg.imobile/files > nul 2>&1 
adb shell mkdir /data/media/0/Android/data/com.pubg.imobile/files/UE4Game > nul 2>&1 
adb shell mkdir /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra > nul 2>&1 
adb shell mkdir /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra > nul 2>&1 
adb shell mkdir /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved > nul 2>&1 
adb shell mkdir /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/savegames > nul 2>&1 
adb shell mkdir /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/config > nul 2>&1 
adb shell mkdir /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/config/android > nul 2>&1 
adb shell mv -f -i /data/media/0/lightdata /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/lightdata > nul 2>&1
adb shell mv -f -i /data/media/0/SrcVersion.ini /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SrcVersion.ini > nul 2>&1
adb shell mv -f -i /data/media/0/paks /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/paks > nul 2>&1
adb shell mv -f -i /data/media/0/active.sav /data/media/0/Android/data/com.pubg.imobile/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/savegames/active.sav > nul 2>&1
